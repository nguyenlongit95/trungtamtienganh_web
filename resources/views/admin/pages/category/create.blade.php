                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeyup="renderSlug()" id="name" name="name" class="form-control" placeholder="Tên danh mục">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                ...
                                <p>- Sau khi nhập xong thông tin trên các trường dữ liệu phía trên quản lý hãy click vào nút <span class="text-danger">(Thêm mới)</span> để thêm mới danh mục.</p>
                            </div>
                        </div>
                    </div>
